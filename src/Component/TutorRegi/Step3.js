...
//               <>
//                 <label htmlFor="medium">Available :</label>
//                 <select name="status" ref={register} defaultValue={tuition?.available}>
//                   <option value={true}>Available</option>
//                   <option value={false}>Not Available</option>
//                 </select>
//               </>
...
//         ) : (
//           <div className="two_btn">
//             <Button color="secondary" variant="contained" onClick={() => count(2)} disabled={spin}>
//               Back
//             </Button>
//             <Button type="submit" color="primary" variant="contained" disabled={spin}>
//               {spin && (
